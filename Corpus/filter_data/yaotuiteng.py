...
class MongodbToExcel(object):
    def __init__(self):
        ...
        self.collection = db['yaotuiteng']
        self.total = 0
        self.row = 0
        self.col = 0
        self.rb = xlwt.Workbook(encoding='utf-8')
        self.sheet = self.rb.add_sheet(u'腰腿疼', cell_overwrite_ok=True)
        self.path = r"E:/01 Project/corpus-spider/corpus/filter_data/腰腿疼.xls"
        self.getMongodb()
